...
const FALLBACK_GAMES = {
  ...
  // 7/2 R32
  "esp-aut": { home_team:"Spain",          away_team:"Austria",           completed:true, scores:[{name:"Spain",score:"3"},{name:"Austria",score:"0"}],                    h1Home:2, h1Away:0 },
  "por-cro": { home_team:"Portugal",       away_team:"Croatia",           completed:true, scores:[{name:"Portugal",score:"2"},{name:"Croatia",score:"1"}],                  h1Home:0, h1Away:0 },
  "sui-alg": { home_team:"Switzerland",    away_team:"Algeria",           completed:true, scores:[{name:"Switzerland",score:"2"},{name:"Algeria",score:"0"}],               h1Home:1, h1Away:0 },
  // 7/3 R32
  ...
  // 7/5 R16
  "bra-nor": { home_team:"Brazil",         away_team:"Norway",            completed:true, scores:[{name:"Brazil",score:"1"},{name:"Norway",score:"2"}],                     h1Home:0, h1Away:0 },
  "mex-eng": { home_team:"Mexico",         away_team:"England",           completed:true, scores:[{name:"Mexico",score:"2"},{name:"England",score:"3"}],                    h1Home:0, h1Away:2 },
  // 7/6 R16
  "por-esp": { home_team:"Portugal",       away_team:"Spain",             completed:true, scores:[{name:"Portugal",score:"0"},{name:"Spain",score:"1"}],                    h1Home:0, h1Away:0 },
  "usa-bel": { home_team:"USA",            away_team:"Belgium",           completed:true, scores:[{name:"USA",score:"1"},{name:"Belgium",score:"4"}],                      h1Home:1, h1Away:2 },
  // 7/7 R16
  "arg-egy": { home_team:"Argentina",      away_team:"Egypt",             completed:true, scores:[{name:"Argentina",score:"3"},{name:"Egypt",score:"2"}],                    h1Home:0, h1Away:1 },
  "sui-col": { home_team:"Switzerland",    away_team:"Colombia",          completed:true, scores:[{name:"Switzerland",score:"0"},{name:"Colombia",score:"0"}],               h1Home:0, h1Away:0 },
  // 7/9 QF
  ...
  // 7/14 SF
  "fra-esp": { home_team:"France",         away_team:"Spain",             completed:true, scores:[{name:"France",score:"0"},{name:"Spain",score:"2"}],                     h1Home:0, h1Away:1 },
  // 7/15 SF
  "eng-arg": { home_team:"England",        away_team:"Argentina",         completed:true, scores:[{name:"England",score:"1"},{name:"Argentina",score:"2"}],                  h1Home:0, h1Away:0 },
  // 7/18 3rd place
  "fra-eng": { home_team:"France",         away_team:"England",           completed:true, scores:[{name:"France",score:"4"},{name:"England",score:"6"}],                     h1Home:2, h1Away:3 },
};
